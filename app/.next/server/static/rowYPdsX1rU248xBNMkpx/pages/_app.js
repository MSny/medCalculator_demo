...
// CONCATENATED MODULE: ../redux/reducers/calculatorReducer.js


const calculatorReducer = (state = {value: 0}, action) => {
    switch (action.type) {
        case calculatorActions["a" /* SET_AGE */]:
            return {...state, value: state.value + 1};
        case calculatorActions["b" /* SET_WEIGHT */]:
            return {...state, value: state.value - 1};
        default:
            return {...state};
    }
...
const Layout = ({
  children
}) => __jsx(external_react_["Fragment"], null, __jsx(head_default.a, null, __jsx("meta", {
...
class _app_Admin extends app_default.a {
  constructor() {
    super();
    this.state = {};
  }
  ...
  render() {
    ...
    return _app_jsx(app["Container"], null, _app_jsx(components_Layout, null, _app_jsx(external_react_redux_["Provider"], {
      store: store
...
/* harmony default export */ var _app = __webpack_exports__["default"] = (external_next_redux_wrapper_default()(makeStore)(_app_Admin));
...
/* unused harmony export setAge */
/* unused harmony export setWeight */
